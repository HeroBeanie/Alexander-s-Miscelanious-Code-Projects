...
List = function () {};
List.prototype.init = function(node) {};
...
Cons.prototype.append = function(list){
    return new Cons(this.head,this.tail).append;
};
...
Cons.prototype.toString = function(){
    var string = '[';
    string += this.head;
    var currentlist = this.tail;
    while(!(currentlist instanceof Nil)){
        string += currentlist.head;
...
Cons.prototype.join = function(delim){
...
Nil.prototype.join = function(delim) {
    return join(this, delim);
};
