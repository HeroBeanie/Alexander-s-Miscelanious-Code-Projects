      ...
      key symbols for the Texas Instruments BA-II PLus in their Microsoft(R) Windows(R) and Macintosh(R) documents.
      
      Note: Macintosh version provided upon request.
      
      This document describes how to install and use the BA-II PLus Symbols font on PCs.
      ...
      symbols printed on the BA-II PLus. TI is distributing, for limited use,
      the scaleable outline font used in the BA-II PLus manual and other
      printed materials.
      ...
      *  Windows 3.1 or later, with either ATM or TrueType.
      ...
      ---------------------------------------
      1. Copy BAIIPLUS_.TTF to your WINDOWS directory.
      ...
      6. Highlight the font name "BA-II Plus Symbols (TrueType)" and select
      ...
      ----------------------------------
      1. Copy baiiplus_.PFB to the directory where you keep your
         PostScript .PFB files (usually C:\PSFONTS).
      
      2. Copy baiiplus_.PFM to the directory where you keep your
      ...
      5. Highlight the font name "BA-II Plus Symbols" and select "OK."
      ...
      "BA-II Plus Symbols" should show in the font menus and font-
